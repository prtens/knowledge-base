...
|------|---------|-------|--------|---------|-----|
|DM | varchar(4) |  | NO  |  	 | id |
|MC | varchar(50) |  | YES  |   | 名称 | 
|layer | int(11) |  | YES  |   | 	 	| 
|SSDW | varchar(50) |  | YES  |   | 	 	| 
|SZWZ | varchar(50) |  | YES  |   | 校区编号 | 
|KYJS | int(11) |  | YES  |   | 教室数 | 
|user_dm | char(10) |  | YES  |   | 	 	| 
...
|------|---------|-------|--------|---------|-----|
|DM | varchar(14) |  | NO  |  	 | id |
|MC | varchar(254) |  | YES  |   | 名称/id | 
|LX_ID | varchar(2) |  | YES  |   | 	 	| 
|RL | int(11) |  | YES  |   | 人数 | 
|SSDW_ID | varchar(7) |  | YES  |   | 	 	| 
|sysid | char(5) |  | YES  |   | 	 	| 
|Layer | int(11) |  | YES  |   | 	 	| 
|SZWZ | varchar(50) |  | YES  |   | 教学楼编号 | 
|ZT | varchar(1) |  | YES  |   | 	 	| 
|MPH | varchar(40) |  | YES  |   | 	 	| 
...
|字段名 | 数据类型	| 默认值	| 允许非空 | 自动递增 | 备注 |
|------|---------|-------|--------|---------|-----|
|DM | varchar(5) |  | YES  |   | 编号、Id | 
|ZWMC | varchar(60) |  | YES  |   | 系名 | 
|ZWJC | varchar(32) |  | YES  |   | 	 	| 
|YWMC | varchar(50) |  | YES  |   | 	 	| 
|YWJC | varchar(50) |  | YES  |   | 	 	| 
|ZGBM | varchar(24) |  | YES  |   | 学院 id | 
|YZ | varchar(8) |  | YES  |   | 	 	| 
|SJ | varchar(8) |  | YES  |   | 	 	| 
|LXR | varchar(8) |  | YES  |   | 	 	| 
|DH | varchar(20) |  | YES  |   | 	 	| 
...
|字段名 | 数据类型	| 默认值	| 允许非空 | 自动递增 | 备注 |
|------|---------|-------|--------|---------|-----|
|DM | varchar(5) |  | NO  |  	 | 编号、Id |
|ZWMC | varchar(32) |  | YES  |   | 名称 | 
|ZWJC | varchar(32) |  | YES  |   | 	 	| 
...
|ZGBM | varchar(24) |  | YES  |   | 	 	| 
|XZ | varchar(50) |  | YES  |   | 校长 | 
|SJ | varchar(50) |  | YES  |   | 书记 | 
|LXR | varchar(50) |  | YES  |   | 	 	| 
|DH | varchar(20) |  | YES  |   | 	 	| 
|CZ | varchar(14) |  | YES  |   | 	 	| 
|DZYJ | varchar(50) |  | YES  |   | 	 	| 
...
|字段名 | 数据类型	| 默认值	| 允许非空 | 自动递增 | 备注 |
|------|---------|-------|--------|---------|-----|
|DM | varchar(4) |  | NO  |  	 | 编号/id |
|GBZYDM | varchar(8) |  | YES  |   | 国际专业代码 | 
|ZWMC | varchar(50) |  | YES  |   | 专业名称 | 
|ZWJC | varchar(14) |  | YES  |   | 	 	| 
|YWMC | varchar(254) |  | YES  |   | 	 	| 
|YWJC | varchar(50) |  | YES  |   | 	 	| 
|PYCC | char(6) |  | YES  |   | 	 	| 
|XZ | varchar(3) |  | YES  |   | 学制 | 
|ZGBM | varchar(24) |  | YES  |   | 院系id | 
|XWMC | char(20) |  | YES  |   | 	 	| 
|XK | char(10) |  | YES  |   | 	 	| 
...
|ZC_ID | varchar(20) |  | YES  |   | 职称id | 
|TSSF_ID | varchar(2) |  | YES  |   | 	 	| 
|SSDW_ID | varchar(50) |  | YES  |   | 学院id | 
|SRKC | varchar(100) |  | YES  |   | 	 	| 
|SZGW | varchar(50) |  | YES  |   | 	 	| 
|SFZG | varchar(1) |  | YES  |   | 是否在岗 | 
|yjfx | varchar(254) |  | YES  |   | 	 	| 
|sjyjl | varchar(512) |  | YES  |   | 	 	| 
|gzjl | varchar(512) |  | YES  |   | 备注 | 
|shxsjz | varchar(254) |  | YES  |   | 	 	| 
|kycg | varchar(254) |  | YES  |   | 	 	| 
|hjry | varchar(254) |  | YES  |   | 	 	| 
|address | varchar(254) |  | YES  |   | 联系地址 | 
|email | varchar(50) |  | YES  |   | 邮箱 | 
|rxrq | varchar(20) |  | YES  |   | 入校年份 | 
|jys | char(100) |  | YES  |   | 	 	| 
|mz | char(20) |  | YES  |   | 	 	| 
|jg | varchar(50) |  | YES  |   | 	 	| 
|zzmm | varchar(50) |  | YES  |   | 	 	| 
|byyx | varchar(100) |  | YES  |   | 	 	| 
|bysj | varchar(50) |  | YES  |   | 联系电话 | 
|sxzy | varchar(100) |  | YES  |   | 	 	| 
|gzsj	datetime	 	  | YES  |  	 	 
|jszc | char(2) |  | YES  |   | 是否外招聘 | 
|jssj | varchar(50) |  | YES  |   | 	 	| 
|xzzw | varchar(50) |  | YES  |   | 	 	| 
|zcxl | char(10) |  | YES  |   | 	 	| 
|zcjb | char(10) |  | YES  |   | 	 	| 
|sfzh | varchar(18) |  | YES  |   | 身份证号码 | 
|gl | int(11) |  | YES  |   | 	 	| 
|nld | char(20) |  | YES  |   | 	 	| 
|gh | varchar(50) |  | YES  |   | 工号 | 
|grjl | longtext  |  | YES  |   | 简历 |
|passwd | varchar(50) |  | YES  |   | 密码 | 
|e_mail | char(100) |  | YES  |   | 	 	| 
|zp | longblob |  | YES  |    |    |
|csrq_2 | datetime |   | YES  |   | 出生日期 |
|wj | varchar(50) |  | YES  |   | 	 	| 
|photopath | varchar(100) |  | YES  |   | |
|xmpyall | varchar(100) |  | YES  |   | 姓名拼音 |
|xmpy1 | varchar(20) |  | YES  |   | 姓名拼音简写 | 
